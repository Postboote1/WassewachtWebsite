  ...
  return (
    <div className="container py-12">
      <div className="flex flex-col items-start gap-4">
        ...
        <p className="text-muted-foreground max-w-3xl">Angaben gemäß § 5 TMG</p>
      </div>
      ...
      <div className="mt-8 space-y-8">
        <div>
          ...
          <div className="space-y-2">
            <p>Wasserwacht Großmehring</p>
            <p>Musterstraße 123</p>
            <p>85098 Großmehring</p>
            <p>Deutschland</p>
            <p className="mt-4">Telefon: +49 123 456789</p>
            <p>E-Mail: info@wasserwacht-grossmehring.de</p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <p>Anna Schmidt, 2. Vorsitzende</p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <h3 className="text-xl font-bold">Urheberrecht</h3>
            <p className="text-muted-foreground">
